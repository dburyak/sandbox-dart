...
void main() {
  ...
  makeHttpGetRequest(url1, prevDelay).then((httpResp1) {
    print("received url1 response: ${httpResp1.statusCode}, delay=$prevDelay");
    ...
    // note that b2Delay is not available here anymore, as now resp2 handler is not
    // nested inside resp1 handler, hence we need to store it in a variable
    // declared outside
    print("received url2 response: ${httpResp2.statusCode}, delay=$prevDelay");
    ...
    print("received url3 response: ${httpResp3.statusCode}, delay=$prevDelay");
    ...
    print("received url4 response: ${httpResp4.statusCode}, delay=$prevDelay");
    ...
    print("received url5 response: ${httpResp5.statusCode}, delay=$prevDelay");
    ...
    print("received url6 response: ${httpResp6.statusCode}, delay=$prevDelay");
    ...
    print("received url7 response: ${httpResp7.statusCode}, delay=$prevDelay");
